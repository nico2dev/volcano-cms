...
<div class="row">
    <h1 class="text-center" style="margin-bottom: 15px;">Welcome to Volcano Framework</h1>
    <br>
...
<div class="row">
    <div class="col-md-6">
        ...
        <ul class="list-unstyled">
            ...
            <li><i class='fa fa-check text-success'></i> Your version of PHP is 8.2 or higher (detected <b><?= PHP_VERSION; ?></b>).</li>
            <?php } else { ?>
            <li><i class='fa fa-close text-danger'></i> Your version of PHP is too low. You need PHP 8.1 or higher to use Volcano Framework (detected <b><?= PHP_VERSION; ?></b>).</li>
            <?php } ?>
